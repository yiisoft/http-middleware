...
per [RFC 9110, §8.6](https://www.rfc-editor.org/rfc/rfc9110.html#section-8.6) and
[RFC 9112, §6.1](https://www.rfc-editor.org/rfc/rfc9112.html#section-6.1), a `304` response may still carry these
...
removed. By default, this only applies to `304 Not Modified`, since per [RFC 9110, §8.6](https://www.rfc-editor.org/rfc/rfc9110.html#section-8.6)
and [RFC 9112, §6.1](https://www.rfc-editor.org/rfc/rfc9112.html#section-6.1) a `304` response may still carry
